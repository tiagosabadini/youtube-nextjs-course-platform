...
const Header = () => {
    ...
    return (
        <>
            <nav className="bg-primary py-3 fixed left-0 top-0 right-0 sm:py-4 flex justify-start items-center px-4 sm:px-0 sm:justify-center">
                ...
                <div 
                    ...
                    className="sm:hidden fixed left-0 top-0 right-0 h-full bg-gradient-to-r from-background transition-transform data-[open=false]:-translate-x-full">
                ...
                <ul className="p-4 gap-5 hidden sm:inline-flex sm:ml-2">
                    <li><Link data-active={currentPath === "/"} className="data-[active=true]:underline outline-offset-4" href="/">Home</Link></li>
                    <li><Link data-active={currentPath === "/cursos"} className="data-[active=true]:underline outline-offset-4" href="/cursos">Cursos</Link></li>
                    <li>
                        <Link  href="/" className="flex items-center gap-1 outline-offset-4">
                            Blog
                            <MdOutlineOpenInNew />
                        </Link>
                    </li>
